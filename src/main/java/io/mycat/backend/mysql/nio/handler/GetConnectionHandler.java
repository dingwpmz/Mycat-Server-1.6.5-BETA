...
public class GetConnectionHandler implements ResponseHandler {
	...
	public void fieldEofResponse(byte[] header, List<byte[]> fields,
		...
		logger.info("received fieldEofResponse resp: " + conn + " " + new String(header));
	}

	@Override
	public void rowResponse(byte[] row, BackendConnection conn) {
		logger.info("received rowResponse resp: " + conn + " " + new String(row));
	}

	@Override
	public void rowEofResponse(byte[] eof, BackendConnection conn) {
		logger.info("received rowEofResponse resp: " + conn + " " + new String(eof));
	}
